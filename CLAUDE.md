...
- **Known gaps** (panic with clear messages): dynamic-array elements can't be passed by reference or compound-assigned, strings exist only as print/key-query literals, and nested `spawn-window` is rejected.
